    ...
    def generate_with_framepack(self,
        ...
        for section_id in range(section_num):
            ...
            if section_id == 0:
                ...
                if section_id > 1:
                    appearance, motion = self.separate_appearance_and_motion(context_decoded[0])
            ...
            if section_id == 0:
                ...
                latent_without_ref = latents[0][:, 1:, :, :]
                ...
                if section_id == 0:
                    ...
                    new_content = latents[0][:, -GENERATION_FRAMES-1:, :, :]
